# ------------------------------ Documentation ------------------------------ #
# Module:  test_token_farm.py
# This python script contains unit tests for the Token Farm project.
#
#
# Modification History
# 04-21-2022 SRK Script Created.
...
def test_set_price_feed_contract():
    """This test ensures that the setPriceFeedContract() function returns the
    correct price feeds and that this function cannot be called by users other
     than the owner."""
    # Arrange
...
def test_stake_tokens(amount_staked):
    """
    Tests that the balance in Token Farm is equal to the amount_staked.
    Tests that uniqueTokensStaked is correclty updated.
    Tests that address of staker is correctly added to stakers array.

    Returns:
        token_farm - Token Farm Object
        dapp_token - Dapp Token Contract Object
    """
    # Arrange
    if network.show_active() not in LOCAL_BLOCKCHAIN_ENVIRONMENTS:
        pytest.skip("Only for local testing.")
...
def test_issues_tokens(amount_staked):
    """
    Tests that the correct amount of token's are issues based on the user's
    TotalValue.
    """
    # Arrange
    if network.show_active() not in LOCAL_BLOCKCHAIN_ENVIRONMENTS:
